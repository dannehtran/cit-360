...
#Creates a public subnet with CIDR of "172.31.0.0/24" in us-west-2a
...
#Creates a public subnet with CIDR of "172.31.1.0/24" in us-west-2b
...
#Creates a public subnet with CIDR of "172.31.2.0/24" in us-west-2c
...
#Creates a private subnet with CIDR of "172.31.3.0/22" in us-west-2a
resource "aws_subnet" "private_subnet_a" {
  vpc_id = "${var.vpc_id}"
  cidr_block = "172.31.3.0/22"
  availability_zone = "us-west-2a"
...
#Creates a private subnet with CIDR of "172.31.7.0/22" in us-west-2b
resource "aws_subnet" "private_subnet_b" {
  vpc_id = "${var.vpc_id}"
  cidr_block = "172.31.7.0/22"
  availability_zone = "us-west-2b"
  map_public_ip_on_launch = false
...
#Creates a private subnet with CIDR of "172.31.11.0/22" in us-west-2c
resource "aws_subnet" "private_subnet_c" {
  vpc_id = "${var.vpc_id}"
  cidr_block = "172.31.11.0/22"
  availability_zone = "us-west-2c"
  map_public_ip_on_launch = false
...
#Creates a NAT gateway with subnet_id "172.31.3.0/22"
